...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "url": "https://github.com/spatial-memory/spatial-memory/issues",
            "email": "support@spatial-memory.app"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.ModerationStats"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/admin/moderation/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Moderation item",
                        "schema": {
                            "$ref": "#/definitions/model.ModerationItem"
                        }
                    },
                    "400": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ManualReviewRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.VerifySMSRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateCircleRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.FriendCircle"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
                    ...
                    "409": {
                        "description": "Max circles limit reached",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateCircleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/circles/{id}/members": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.CircleMember"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Max members limit reached",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    }
        ...
        "/memories/nearby": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort by: distance, recent, popular (default: distance)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "boolean",
                        "description": "Enable clustering for large result sets",
                        "name": "cluster",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "List of nearby memories",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.Memory"
        ...
        "/memories/{id}/revoke": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Circle ID or User ID",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ConfirmUploadRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UploadRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.Memory": {
            ...
            "properties": {
                ...
                "media": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.MemoryMedia"
                    }
                },
                "status": {
                    "$ref": "#/definitions/model.MemoryStatus"
                },
                "title": {
                    "type": "string"
                },
        ...
        "model.MemoryMedia": {
            ...
            "properties": {
                ...
                "file_size": {
                    "description": "Alias for SizeBytes",
                    "type": "integer"
                },
                "height": {
                    "type": "integer"
        ...
        "model.ModerationItem": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/model.ModerationStatus"
                },
                "user_id": {
                    "type": "integer"
                },
        ...
        "model.UploadRequest": {
            ...
            "properties": {
                ...
                "duration": {
                    "description": "seconds, for video/voice",
                    "type": "integer"
                },
                "file_size": {
                    "type": "integer"
        ...
        "model.UploadResponse": {
            ...
            "properties": {
                ...
                "is_duplicate": {
                    "description": "if true, file already exists",
                    "type": "boolean"
                },
                "storage_key": {
                    "type": "string"
